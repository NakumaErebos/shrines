...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> SHEIKAHSTONE = registerBlock("sheikahstone",
            () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BEDROCK)));

    public static final DeferredBlock<Block> SHEIKAHSTONE_SWIRLS = registerBlock("sheikahstone_swirls",
            () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BEDROCK)));
