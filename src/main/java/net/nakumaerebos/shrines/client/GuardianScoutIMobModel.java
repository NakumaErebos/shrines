...
public class GuardianScoutIMobModel extends GeoModel<GuardianScoutIMobEntity> {

    @Override
    public ResourceLocation getModelResource(GuardianScoutIMobEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Shrines.MOD_ID, "geo/guardianscout.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GuardianScoutIMobEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Shrines.MOD_ID, "textures/entity/guardianscout.png");
    }

    @Override
    public ResourceLocation getAnimationResource(GuardianScoutIMobEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Shrines.MOD_ID, "animations/guardianscout.animation.json");
    }

    @Override
    public void setCustomAnimations(GuardianScoutIMobEntity animatable, long instanceId, AnimationState<GuardianScoutIMobEntity> animationState) {
