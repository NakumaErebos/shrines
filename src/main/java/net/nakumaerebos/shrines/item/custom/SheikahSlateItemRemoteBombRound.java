...
public class SheikahSlateItemRemoteBombRound extends Item {

    public SheikahSlateItemRemoteBombRound(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide && level instanceof ServerLevel serverLevel) {
            ...
            List<RemoteBombRoundEntity> nearbyBombs = level.getEntitiesOfClass(
                    RemoteBombRoundEntity.class,
                    searchBox
            );

            RemoteBombRoundEntity ownedBomb = null;
            for (RemoteBombRoundEntity bomb : nearbyBombs) {
            ...
            if (ownedBomb != null) {
                ...
                RemoteBombRoundEntity newBomb = ModEntities.REMOTE_BOMB_ROUND.get().create(serverLevel);
                if (newBomb != null) {
